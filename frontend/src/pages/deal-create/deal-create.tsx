      ...
      <div className="grid grid-cols-1 items-start gap-4 md:grid-cols-3">
        {isFieldsFetching ? (
          ...
          <div className="col-span-2 rounded-md border border-solid border-[#E5E3FE] bg-white dark:border-neutral-700 dark:bg-transparent">
            <div className="sticky top-0 z-10 flex items-center justify-between rounded-t-md border-0 border-b border-solid border-[#E5E3FE] bg-white px-4 py-2 dark:bg-transparent">
